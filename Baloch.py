...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $Amdad && git clone https://github.com/salman420313/Salman_Zaheer.git
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To Salman_baloch')
	    psb('Congratulations Salman_baloch Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Amdad✓')
	    psb('🔓Password ☆ Salman✓')
	    psb('Subscrib My Youtube Channel  SALMAN BS4 TECH ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd Amdad && python2 Baloch.py)
	elif bm =='3':
